...
module.exports = {
    ...
    async execute(sock, m, options) {
        ...
        try {
            ...
            const menuContent = menuCategoria('membros', prefixoAtual, senderName, sender, config.ownerNumber, botNumberFormatted + '@s.whatsapp.net');
            if (!menuContent) {
                await sock.sendMessage(from, { text: "Nenhum comando encontrado na categoria Membros." }, { quoted: m });
                return;
            }
            ...
            await sock.sendMessage(from, {
                interactiveMessage: {
                    title: menuContent,
                    footer: "SYSTEM-SONIC - Menu Membros",
                    thumbnail: thumbnail,
                    nativeFlowMessage: {
            ...
            console.error("Erro menumembros:", error.message);
            await sock.sendMessage(from, { text: "Erro ao exibir o menu Membros." }, { quoted: m });
        }
    }
};
