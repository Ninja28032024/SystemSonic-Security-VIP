...
module.exports = {
    ...
    async execute(sock, m, options) {
        ...
        try {
            ...
            const menuContent = menuCategoria('admin', prefixoAtual, senderName, sender, config.ownerNumber, botNumberFormatted + '@s.whatsapp.net');
            if (!menuContent) {
                await sock.sendMessage(from, { text: "Nenhum comando encontrado na categoria Admin." }, { quoted: m });
                return;
            }
            ...
            await sock.sendMessage(from, {
                interactiveMessage: {
                    title: menuContent,
                    footer: "SYSTEM-SONIC - Menu Admin",
                    thumbnail: thumbnail,
                    nativeFlowMessage: {
            ...
            console.error("Erro menuadm:", error.message);
            await sock.sendMessage(from, { text: "Erro ao exibir o menu Admin." }, { quoted: m });
        }
    }
};
