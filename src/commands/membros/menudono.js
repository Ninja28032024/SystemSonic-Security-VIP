...
module.exports = {
    ...
    async execute(sock, m, options) {
        ...
        try {
            ...
            const menuContent = menuCategoria('dono', prefixoAtual, senderName, sender, config.ownerNumber, botNumberFormatted + '@s.whatsapp.net');
            if (!menuContent) {
                await sock.sendMessage(from, { text: "Nenhum comando encontrado na categoria Dono." }, { quoted: m });
                return;
            }
            ...
            console.error("Erro menudono:", error.message);
            await sock.sendMessage(from, { text: "Erro ao exibir o menu Dono." }, { quoted: m });
        }
    }
};
