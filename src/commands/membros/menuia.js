...
module.exports = {
    ...
    async execute(sock, m, options) {
        ...
        try {
            ...
            const menuContent = menuCategoria('ia', prefixoAtual, senderName, sender, config.ownerNumber, botNumberFormatted + '@s.whatsapp.net');
            if (!menuContent) {
                await sock.sendMessage(from, { text: "Nenhum comando encontrado na categoria IAs." }, { quoted: m });
                return;
            }
            ...
            console.error("Erro menuia:", error.message);
            await sock.sendMessage(from, { text: "Erro ao exibir o menu IAs." }, { quoted: m });
        }
    }
};
