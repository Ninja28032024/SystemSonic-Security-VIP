...
module.exports = {
    name: "menubrinca",
    aliases: ["menubrincadeira","menu-brincadeira"],
    async execute(sock, m, options) {
        ...
        try {
            ...
            const menuContent = menuCategoria('brincadeiras', prefixoAtual, senderName, sender, config.ownerNumber, botNumberFormatted + '@s.whatsapp.net');
            if (!menuContent) {
                await sock.sendMessage(from, { text: "Nenhum comando encontrado na categoria Brincadeiras." }, { quoted: m });
                return;
            }
            ...
            await sock.sendMessage(from, {
                interactiveMessage: {
                    title: menuContent,
                    footer: "SYSTEM-SONIC - Menu Brincadeiras",
                    thumbnail: thumbnail,
                    nativeFlowMessage: {
            ...
            console.error("Erro menubrinca:", error.message);
            await sock.sendMessage(from, { text: "Erro ao exibir o menu Brincadeiras." }, { quoted: m });
        }
    }
};
